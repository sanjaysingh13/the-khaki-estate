        ...
        try:
            with transaction.atomic():
                ...
                for category_data in categories_data:
                    category, created = MaintenanceCategory.objects.get_or_create(
                        ...
                        defaults={
                            ...
                            'estimated_resolution_hours': category_data['estimated_resolution_hours'],
                        }
                    )
                    ...
                    if created:
                        ...
                        if category.priority_level != category_data['priority_level']:
                            ...
                            updated = True
                        if category.estimated_resolution_hours != category_data['estimated_resolution_hours']:
                            category.estimated_resolution_hours = category_data['estimated_resolution_hours']
                            updated = True
                ...
                for priority in range(1, 5):
                    count = MaintenanceCategory.objects.filter(priority_level=priority).count()
                    priority_names = {
                        1: "Low (Routine)",
                        2: "Medium (Standard)",
                        3: "High (Major Issues)",
                    ...
                    self.stdout.write(f"  Priority {priority} - {priority_names[priority]}: {count} categories")
